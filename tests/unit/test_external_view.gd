...
func test_camera_distance_clamping():
	...
	assert_eq(external_view.camera_distance, 150.0, "Distance should increase by delta")
...
func test_camera_tilt_clamping():
	...
	assert_eq(external_view.camera_tilt, 45.0, "Tilt should increase by delta")
...
func test_camera_rotation_normalization():
	...
	assert_almost_eq(
		external_view.camera_rotation, 10.0, 0.01, "Rotation should wrap around at 360"
	)

	# Test rotation wraps around at 0
	external_view.camera_rotation = 10.0
	external_view.handle_rotation_input(-20.0)
	assert_almost_eq(external_view.camera_rotation, 350.0, 0.01, "Rotation should wrap around at 0")
