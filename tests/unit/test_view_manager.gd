...
func test_initial_view_is_tactical_map():
	assert_eq(view_manager.current_view, ViewManager.ViewType.TACTICAL_MAP,
...
func test_switch_to_periscope_view():
	...
	assert_eq(view_manager.current_view, ViewManager.ViewType.PERISCOPE,
...
func test_switch_to_external_view():
	...
	assert_eq(view_manager.current_view, ViewManager.ViewType.EXTERNAL,
...
func test_get_active_camera_tactical():
	...
	assert_eq(camera, view_manager.tactical_map_camera,
...
func test_get_active_camera_periscope():
	...
	var camera = view_manager.get_active_camera()
	assert_eq(camera, view_manager.periscope_camera,
...
func test_get_active_camera_external():
	...
	var camera = view_manager.get_active_camera()
	assert_eq(camera, view_manager.external_camera,
...
func test_periscope_camera_positioned_at_mast():
	...
	assert_almost_eq(view_manager.periscope_camera.global_position, expected_position, Vector3(0.1, 0.1, 0.1),
...
func test_external_camera_orbits_submarine():
	...
	var distance = view_manager.external_camera.global_position.distance_to(simulation_state.submarine_position)
...
func test_submarine_state_preserved_during_view_switch():
	...
	assert_eq(simulation_state.submarine_position, original_position,
		"Submarine position should be preserved during view switches")
	assert_eq(simulation_state.submarine_speed, original_speed,
		"Submarine speed should be preserved during view switches")
	assert_eq(simulation_state.submarine_depth, original_depth,
		"Submarine depth should be preserved during view switches")
	assert_eq(simulation_state.submarine_heading, original_heading,
