...
func test_contact_visible_when_detected_and_identified():
	...
	# Should be visible
	assert_true(fog_of_war.is_contact_visible(contact), 
...
func test_contact_not_visible_when_only_detected():
	...
	assert_false(fog_of_war.is_contact_visible(contact), 
		"Contact should NOT be visible when only detected")
...
func test_contact_not_visible_when_only_identified():
	...
	# Should NOT be visible
	assert_false(fog_of_war.is_contact_visible(contact), 
		"Contact should NOT be visible when only identified")
...
func test_null_contact_not_visible():
	...
	assert_false(fog_of_war.is_contact_visible(null), 
		"Null contact should not be visible")
...
func test_environment_always_visible():
	...
	assert_true(fog_of_war.is_environment_visible("terrain"), 
		"Terrain should always be visible")
	assert_true(fog_of_war.is_environment_visible("ocean"), 
		"Ocean should always be visible")
	assert_true(fog_of_war.is_environment_visible("atmosphere"), 
		"Atmosphere should always be visible")
	assert_true(fog_of_war.is_environment_visible("sealife"), 
		"Sealife should always be visible")
	assert_true(fog_of_war.is_environment_visible(""), 
		"Any environmental element should be visible")
...
func test_visibility_changes_with_detection_status():
	...
	assert_false(fog_of_war.is_contact_visible(contact), 
		"Contact should not be visible initially")
