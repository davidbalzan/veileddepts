...
var chunk_renderer: MockChunkRenderer = null
...
class MockChunkRenderer:
	...
	func create_chunk_mesh(_heightmap, _biome_map, _chunk_coord, _lod_level, _neighbor_lods = {}) -> ArrayMesh:
		...
		# We don't need actual geometry for these tests, just a non-null return
		# but let's add a dummy surface just in case
...
func before_each() -> void:
	...
	chunk_renderer = MockChunkRenderer.new()
