...
func test_camera_position_tracks_submarine_mast():
	...
	assert_almost_eq(
		periscope_view.camera.global_position,
		expected_position,
...
func test_rotation_input_updates_camera():
	...
	assert_almost_eq(
		periscope_view.camera.rotation.y,
		expected_rotation_rad,
		0.01,
...
func test_underwater_mode_switches_environment():
	...
	assert_null(
		...
		"Camera should not have underwater environment at surface"
	)
	...
	assert_eq(
		periscope_view.camera.environment,
		periscope_view.underwater_environment,
