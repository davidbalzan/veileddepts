...
func _update_binding_button_text(action: String) -> void:
	var button = input_remapping_ui.get_node("MainPanel/BindingsScroll/BindingsContainer/" + action + "_container/" + action + "_button")
	if not button:
		return
...
func _start_key_remapping(action: String) -> void:
	...
	remapping_button = input_remapping_ui.get_node("MainPanel/BindingsScroll/BindingsContainer/" + action + "_container/" + action + "_button")
