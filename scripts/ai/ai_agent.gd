...
enum State { PATROL, SEARCH, ATTACK }  # Following waypoint route, scanning for submarine  # Investigating last known submarine position  # Within attack range, executing attack patterns
