...
func _enter_tree():
	...
	add_custom_type("Ocean3D", "Resource", preload("res://addons/tessarakkt.oceanfft/components/Ocean3D.gd"), preload("res://addons/tessarakkt.oceanfft/icons/Ocean3D.svg"))
	add_custom_type("QuadTree3D", "Node3D", preload("res://addons/tessarakkt.oceanfft/components/QuadTree3D.gd"), preload("res://addons/tessarakkt.oceanfft/icons/QuadTree3D.svg"))
...
func _exit_tree():
	...
	remove_custom_type("BuoyancyProbe3D")
